...
class ExistingModeOfRequestFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.prep_existing_mode_of_request_fragment,container,false)
...
//            Toast.makeText(context, text, Toast.LENGTH_SHORT).show()
    ...
    private fun checkEditText2(view: View){
        if (TextUtils.isEmpty(view.et_tt.text.toString())||
