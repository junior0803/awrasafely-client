...
import com.pragmanila.awrasafely.ui.arv.fragments.ClientTypeFragment
...
class ARVRequestActivity : AppCompatActivity(){

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.arv_request)
        ...
        ll_back.setOnClickListener(View.OnClickListener {
            startActivity(Intent(this@ARVRequestActivity, LandingPageActivity::class.java))
            finish()
        })
